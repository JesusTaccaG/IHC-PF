...
class Imagess(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, width, height):
        ...
        self.actual = None
        pygame.font.init()
        temp = pygame.font.Font(None,27)
        self.palabra = 'Rana Come Palabras'
    ...
    def update_size(self, width, height):
        ...
        self.image5 = img5
        self.image6 = img6
    #_________________________________________________Dibujar Imagenes
    def draw(self,buff):
        buff.blit(self.actual, (self.x, self.y+210)) ##Rana posicion
        buff.blit(self.image6, (self.x+150, self.y-190)) ##Mosca posicion
        buff.blit(self.texto,(self.x-52,self.y-170)) #Texto posicion
    ...
    def func(self,juego):
        imagenes_pos = pygame.mouse.get_pos()
        click = pygame.mouse.get_pressed()
        if True==self.isOver(imagenes_pos) and not self.presiono:
